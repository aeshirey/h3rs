...
fn _baseCellToFaceIjk(baseCell:i32) -> Self {
    ...
    fn _faceIjkPentToGeoBoundary(&self /* h */, res:i32, start:i32, length:i32) -> GeoBoundary /* g */ {
        todo!()
            /*
               int adjRes = res;
               FaceIJK centerIJK = *h;
    ...
    */
    ...
    fn _adjustOverageClassII(&mut self /*fijk*/, res:i32, pentLeading4:bool, substrate:bool) -> Overage {
...
const faceCenterPoint : [Vec3d; NUM_ICOSA_FACES] = [
    ...
    Vec3d::new(-0.8112534709140971, -0.3448953237639382, -0.4721387736413930),  // face 16
    Vec3d::new(-0.2199307791404607, -0.6583691780274996, -0.7198475378926182),  // face 17
