...
impl GeoCoord {
    ...
    /// the future.
    fn hexAreaKm2(res: Resolution) -> f64 {
        const AREAS: [f64; 16] = [
            4250546.848,
            607220.9782,
            86745.85403,
    ...
    fn hexAreaM2(res: Resolution) -> f64 {
        const AREAS: [f64; 16] = [
            4.25055E+12,
            6.07221E+11,
            86745854035.,
    ...
    fn _geoToFaceIjk(&self, res: Resolution) -> FaceIJK {
     ...
     */
    fn geoToH3(&self, res: Resolution) -> H3Index {
